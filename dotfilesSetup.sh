...
clone_dotfiles() {
	...
	while true; do
		print_message "${BLUE}Acceptable Syntax: ${NC}"
...
while $repeat_script; do
	...
	echo -e " ${YELLOW}- Specify clone directory"
	...
	echo -e " ${YELLOW}- Overwrite existing dotfiles"
	echo -e " ${YELLOW}- Backup existing dotfiles"
	echo -e " ${YELLOW}- Repeat any section of the script"
	echo -e "\n${BLUE}------------------------------------------------------------------------------"
	print_warning "${YELLOW}NOTE: ${BLUE}It is super-interactive and will ask you for confirmation before proceeding."
